...
function changeCanvas(new_color)
{
...
{ 
	var img = document.getElementById("kremen");
    ctx.drawImage(img, 100,100,500,400);
  }
  function changePicture()
  {
  	var img = document.getElementById("gusar");
  	ctx.drawImage(img,100,100,500,400);
  }
  function changePlay()
  {
  	var img = document.getElementById("klizaci");
  	ctx.drawImage(img,100,100,500,400);
  }
  function changeSnow()
  {
  	var img = document.getElementById("pahuljica");
  	ctx.drawImage(img,100,100,500,400);
  }
  function changeStar()
  {
    var img = document.getElementById("zvezdica");
    ctx.drawImage(img,100,100,500,400);
  }

function changeHeart()
{
  var img = document.getElementById("srce");
    ctx.drawImage(img,100,100,500,400);
  }

  function changeDexter()
  {
    var img = document.getElementById("dexter");
    ctx.drawImage(img,100,100,500,400);
  }
function changeMikey()
{
  var img = document.getElementById("miki");
    ctx.drawImage(img,100,100,500,400);
}
function changeFish()
{
  var img = document.getElementById("riba");
    ctx.drawImage(img,100,100,500,400);
}
function changeRiba()
{
  var img = document.getElementById("pecaros");
    ctx.drawImage(img,100,100,500,400);
}
function changeBuva()
{
   var img = document.getElementById("buva");
    ctx.drawImage(img,100,100,500,400); 
}
function changeFrog()
{
  var img = document.getElementById("zaba");
    ctx.drawImage(img,100,100,500,400);
}